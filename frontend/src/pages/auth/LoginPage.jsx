...
const LoginContent = () => {
  const { login, googleLogin, isAuthenticated, requireGuest, clearError } = useAuth();
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        // This sends the access_token to your existing googleLogin function
        ...
        <div className="bg-white border-4 border-primary-900 p-8 shadow-[8px_8px_0_0_#1e3a8a]">
          ...
          <div className="mt-6 pt-6 border-t-2 border-primary-900/20">
            ...
            >
              ...
              <span className="font-mono text-xs uppercase tracking-widest">Sign in with Google</span>
            </button>
          </div>
        </div>

        <p className="mt-6 text-center text-primary-900">
          <span className="text-primary-600 font-medium">New to Zignature? </span>
...
const LoginPage = () => (
  <>
    <SEO title="Login" description="Login to your Zignature account" noindex={true} />
